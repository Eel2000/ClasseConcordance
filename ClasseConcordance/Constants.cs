...
namespace ClasseConcordance
{
    public static class Constants
    {
        ...
        public static string URL_CREATE_USER = "https://klasroom-demo.eteyelo.com/Administration/UpdateUsers";

        public static string CONFIGURATION_FILE = @"c:\EteyeloMigrationsScript\appsettings.json";
